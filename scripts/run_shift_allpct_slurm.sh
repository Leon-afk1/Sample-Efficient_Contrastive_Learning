#!/usr/bin/env bash
#SBATCH --job-name=har_random_shift_allpct
...
#SBATCH --output=Log/slurm/random_shift_%A_%a.out
#SBATCH --error=Log/slurm/random_shift_%A_%a.err
...
echo "==========================================" | tee -a "$LOG_FILE"
echo "RANDOM+SHIFT MINING — $PCT_LABEL" | tee -a "$LOG_FILE"
echo "==========================================" | tee -a "$LOG_FILE"
